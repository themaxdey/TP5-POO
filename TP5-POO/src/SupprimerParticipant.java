...
/**
 * La classe SupprimerParticipant permet de faire des suppressions de participants au programme de réemploi
...
public class SupprimerParticipant implements OutilsConstantes {
	...
	/**
	 * Le constructeur SupprimerParticipant() permet de gérer les suppressions de participants
	 * au programme de réemploi de matériel informatique de MomoTech. On ne peut pas supprimer
	 * un participant à qui du matériel informatique a été assigné.
	 * 
	 * @param momoTech
