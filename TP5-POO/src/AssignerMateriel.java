...
/**
 * La classe AssignerMateriel permet d'assigner du matériel informatique, à des participants au programme de réemploi
...
public class AssignerMateriel implements OutilsConstantes {
	...
	/**
	 * Le constructeur AssignerMateriel() permet d'assigner du matériel informatique, à des participants au programme
	 * de réemploi de matériel informatique de l'entreprise MomoTech. On assigne uniquement du matériel informatique
	 * qui n'est pas déjà assigné à un participant.
	 * 
	 * @param momoTech
