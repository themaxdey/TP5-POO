...
/**
 * La classe ConsulterTousParticipants permet de faire la consultation de tous les participants au
 * programme de réemploi de matériel informatique de MomoTech. Cette classe implémente l'interface
 * OutilsConstantes.
 */
...
public class ConsulterTousParticipants implements OutilsConstantes {
	...
	/**
	 * Le constructeur ConsulterTousParticipants() permet de consulter tous les participants 
